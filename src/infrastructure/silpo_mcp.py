"""Silpo MCP client: persistent OAuth token storage (docs/decisions.md #5)
and the code-level tool allowlist (docs/decisions.md #24 — closes F24,
the seeded Docs prompt's dead file-path reference).
